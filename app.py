...
if "matches" not in st.session_state:
    # Split the list to prevent syntax errors during initialization
    part1 = [
    ...
    part2 = [
        ...
        {"Group": "Finals", "Wave": "W6", "Time": "18:35", "Court": "5", "Phase": "Shart in your pants Cup", "Team 1": "TBD", "Score 1": 0,
