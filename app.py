...
if "matches" not in st.session_state:
    st.session_state["matches"] = [
        ...
        # Semis
        {"Group": "Knockout", "Wave": "W5", "Phase": "Semi Final 1", "Team 1": "G1 3rd", "Score 1": 0, "Team 2": "G2 4th", "Score 2": 0},
        {"Group": "Knockout", "Wave": "W5", "Phase": "Semi Final 2", "Team 1": "G1 4th", "Score 1": 0, "Team 2": "G2 3rd", "Score 2": 0},
        {"Group": "Knockout", "Wave": "W5", "Phase": "Semi Final 3", "Team 1": "G1 1st", "Score 1": 0, "Team 2": "G2 2nd", "Score 2": 0},
        {"Group": "Knockout", "Wave": "W6", "Phase": "Semi Final 4", "Team 1": "G1 2nd", "Score 1": 0, "Team 2": "G2 1st", "Score 2": 0},
        # Finals
        {"Group": "Finals", "Wave": "W6", "Phase": "Shit the Bed Cup", "Team 1": "L-SF1", "Score 1": 0, "Team 2": "L-SF2", "Score 2": 0},
        {"Group": "Finals", "Wave": "W6", "Phase": "Shart in your pants Cup", "Team 1": "W-SF1", "Score 1": 0, "Team 2": "W-SF2", "Score 2": 0},
        {"Group": "Finals", "Wave": "W7", "Phase": "Shitstain Cup", "Team 1": "L-SF3", "Score 1": 0, "Team 2": "L-SF4", "Score 2": 0},
        {"Group": "Finals", "Wave": "W8", "Phase": "Champions Cup", "Team 1": "W-SF3", "Score 1": 0, "Team 2": "W-SF4", "Score 2": 0}
    ]
    ...
    if "edited_rows" in delta:
        for idx, up in delta["edited_rows"].items():
            ...
            for m in st.session_state["matches"]:
                if m.get("Group") == match_row["Group"] and m.get("Team 1") == match_row["Team 1"]:
                    m.update(up)
...
for section in ["Knockout", "Finals"]:
    ...
    st.data_editor(sub, key=f"e_{section}", hide_index=True, use_container_width=True, on_change=update_scores, args=(f"e_{section}", sub))
